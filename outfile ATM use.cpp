...
//************************************************************************************
	...
	class ATMAccountHolders:public Bank
	    ...
	    accountNumber = 5678;
	    accountHolders = "Junaid ";
	    accountHoldersAddress = "Lahore";
...
//**********************************************************************************************
//                   FILE HAMDLING (CREATING FILE )
//**********************************************************************************************		
		
		   
		ofstream outfile("E:\\ Details.text",ios::out);  // using ofstream for writing into the file
		outfile<< accountHolders<<endl;
		outfile<< accountHoldersAddress<<endl;
		outfile<< branch<<endl;
	...
	void ATMAccountHolders::details()
	    {
	   	...
	   	ifstream infile("E:\\ Details.text",ios::in);  // using ifstream for reading info from the file
		infile>> accountHolders;
		infile>> accountHoldersAddress;
		infile>> branch ;
		...
		infile.close();
	        ...
	        cout<<"\tStartBalance :"<<startBalance<<"\n\n";
...
//********************************************************************************************************
	    ...
	    }while(e!=0);   // we have not press 0 to get help 
